...
setInterval(() => {
  http.get(`http://faxbot.glitch.me/`);
}, 280000);
...
client.on('ready', () => {
     client.user.setActivity("FaxBOT |Updating",{type: 'Watching'});
...
message.channel.send('**<a:True:727338319226077204>| Bot Orders\n----------------------------\n<a:Like:727338226355929140> | ``-Profiles`` ➺ أوامـر الـبـروفـايـل\n<a:Happyx2:727338202402127892> | ``-Public`` ➺ أوامـر الـعـامـة\n<a:Admin:727338197167898657> | ``-Admin`` ➺ أوامـر الأدمـن\n<a:Happy:727338288171712575> | ``-Giveaway`` ➺ أوامـر الجـيـفـاواي\n<a:Error:727338196681097237> | ``-Protection`` ➺ أوامـر الـحـمـايـة\n<a:Ticket2:727338297902366821> | ``-Tickets`` ➺ أوامـر الـتـيـكـيـت\n<a:Truex2:727338201697746964> | ``-Submit`` ➺ أوامـر الـتـقـديـم\n<a:Spiner:727338281544712222> | ``-Games`` ➺ أوامـر الألـعـاب**')
   }
});
client.on('message', message => {
  if (message.author.bot) return;
   if (message.content === prefix + "test") {
message.channel.send('**<a:True:727338319226077204> | Bot Commands/n----------------------------/n<a:Like:727338226355929140> **')
  }
});
...
if (message.content === prefix+'Profiles') {
          message.author.send('**<a:Nitro:727520490830168104> | Profile Menu\n----------------------------\n<a:Nitro:727520490830168104> | ``-profile`` ⇏ لـعـرض الـبـروفـايـل الـخـاص بـك\n\n<a:Nitro:727520490830168104> | ``-note`` ⇏ لـوضـع سـيـرة ذاتـيـة لـبـروفـايـلـك\n\n<a:Nitro:727520490830168104> | ``-rep`` ⇏ لأعطـاء ريـب لـشـخـص\n\n<a:Nitro:727520490830168104> | ``-credits`` ⇏ لـرؤيـة الـكـريدت الـخـاص بـك\n\n<a:Nitro:727520490830168104> | ``-daily`` ⇏ لاخـذ حـصـتـك الـيـومـيـة مـن الـكـريدت\n\n<a:Nitro:727520490830168104> | ``-trans @mention amount`` ⇏ لـتـحويـل كـريدت لشـخـص اخر\n----------------------------**').catch(e => console.log(e.stack)); 
    }
   }
  });
...
if (!message.guild) return message.reply('') 
if (message.content === prefix+'Profiles') {
message.channel.send("<a:Truex2:727338203773927514> **-** **Done! Check Your DM**")
  }
   });
...
if (message.content === prefix+'Public') {
      message.author.send('**<a:Nitro:727520490830168104> | Public Menu\n----------------------------\n<a:Nitro:727520490830168104> | ``-avatar`` ⇏ لـعـرض صـورتـك\n\n<a:Nitro:727520490830168104> | ``-image`` ⇏ لـعـرض صـورة الـسـيرفـر\n\n<a:Nitro:727520490830168104> | ``-user`` ⇏ لـرؤيـة مـعـلـومـاتـك \n\n<a:Nitro:727520490830168104> | ``-server`` ⇏ لـرؤيـة مـعـلـومـات عـن الـسـيـرفـر\n\n<a:Nitro:727520490830168104> | ``-allbots`` ⇏ لـمـعـرفـة كـم بـوت بالـسـيـرفـر\n\n<a:Nitro:727520490830168104> | ``-colors`` ⇏ لـعـرض قـائـمـة الألـوان\n\n<a:Nitro:727520490830168104> | ``-color`` ⇏ لاخـتـيـار لـون فـي الـسـيـرفـر\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Admin') {
      message.author.send('**<a:Nitro:727520490830168104> | Admin Menu\n----------------------------\n<a:Nitro:727520490830168104> | ``-uptime`` ⇏ لـمـعـرفـة كـم صـار الـبـوت شـغـال\n\n<a:Nitro:727520490830168104> | ``-mute`` ⇏ لأعطـاء مـيـوت كـتـابـي\n\n<a:Nitro:727520490830168104> | ``-unmute`` ⇏ لـفـك الـمـيـوت الـكـتـابـي\n\n<a:Nitro:727520490830168104> | ``-kick`` ⇏ لأعـطـاء طـرد لـشـخـص\n\n<a:Nitro:727520490830168104> | ``-ban`` ⇏ لـتـبـنـيد عـضـو\n\n<a:Nitro:727520490830168104> | ``-unban`` ⇏ لـفـك الـبـانـد عـن عـضـو\n\n<a:Nitro:727520490830168104> | ``-setnick`` ⇏ لـتـغـيـر اسـم عـضـو\n\n<a:Nitro:727520490830168104> | ``-moveall`` ⇏ لـسـحـب جـمـيـع الأعـضـاء للـروم الـصـوتـي\n\n<a:Nitro:727520490830168104> | ``-mc`` ⇏ لـقـفـل الـشـات\n\n<a:Nitro:727520490830168104> | ``-uc`` ⇏ لـفـتـح الـشـات\n\n<a:Nitro:727520490830168104> | ``-ct`` ⇏ لأنـشـاء روم كـتـابـي\n\n<a:Nitro:727520490830168104> | ``-cv`` ⇏ لأنـشـاء روم صـوتـي\n\n<a:Nitro:727520490830168104> | ``-clear`` ⇏ لـمـسـح عـدد مـعـيـن مـن الـرسـائـل\n---------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Giveaway') {
      message.author.send('**<a:Nitro:727520490830168104> | Giveaway Menu\n----------------------------\n<a:Nitro:727520490830168104> | ``-start`` ⇏ لـبـدا قـيـفـاواي\n<a:Nitro:727520490830168104> | ``-reroll`` ⇏ لاعـادة اخـتـيـار فـائـز اخـر\n<a:Nitro:727520490830168104> | ``-gend`` ⇏ لأنـهـاء الـقـيفـاواي\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Protection') {
      message.author.send('**<a:Nitro:727520490830168104> | Protection Menu\n----------------------------\n<a:Nitro:727520490830168104> | ``-antibots on`` ⇏ لـتـفـعـيـل مـانـع دخـول الـبـوتـات\n\n<a:Nitro:727520490830168104> | ``-antibots off`` ⇏ لاغـلاق مـانـع دخـول الـبـوتـات\n\n<a:Nitro:727520490830168104> | ``-settings limitsban`` ⇏ لـتـحـديـد عـدد أقـصـي للـبـانـد\n\n<a:Nitro:727520490830168104> | ``-settings limitskick`` ⇏ لـتـحـديـد عـدد أقـصـي للـطـرد\n\n<a:Nitro:727520490830168104> | ``-settings limitsroleC`` ⇏ لـتـحـديـد عـدد أقـصـي لأنـشـاء رول\n\n<a:Nitro:727520490830168104> | ``-settings limitsroleD`` ⇏ لـتـحـديـد عـدد أقـصـي لـمـسـح رول\n\n<a:Nitro:727520490830168104> | ``-settings limitschannelD`` ⇏ لـتـحـديـد عـدد أقـصـي لـمـسـح روم\n---------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Tickets') {
      message.author.send('**<a:Nitro:727520490830168104> | Ticket Menu\n----------------------------\n<a:Nitro:727520490830168104> | ``-new`` ⇏ لأنـشـاء تـذكـرة\n\n<a:Nitro:727520490830168104> | ``-close`` ⇏ لـقـفـل تـذـكـرة\n\n<a:Nitro:727520490830168104> | ``-add`` ⇏ لأضـافـة شـخـص للـتـذـكـرة\n\n<a:Nitro:727520490830168104> | ``-remove`` ⇏ لأزالـة شـخـص مـن الـتـذكـرة\n\n<a:Nitro:727520490830168104> | ``-mtickets`` ⇏ لـتـفـعـيـل واغـلاق خـاصـيـة فـتـح الـتـذاكـر\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Submit') {
      message.author.send('**<a:Nitro:727520490830168104> | Submit Menu\n----------------------------\n<a:Nitro:727520490830168104> | ``-room1`` ⇏ لأنـشـاء روم الـتـقـديـمـات\n\n<a:Nitro:727520490830168104> | ``-room2`` ⇏ لأنـشـاء روم الـقـبـول والـرفـض\n\n<a:Nitro:727520490830168104> | ``-submit`` ⇏ للـتـقـديـم عـلـي رتـبـة\n\n<a:Nitro:727520490830168104> | ``-apply @user RoleName`` ⇏ لـقـبـول عـضـو\n\n<a:Nitro:727520490830168104> | ``-reject @user`` ⇏ لـرفـض عـضـو\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Games') {
      message.author.send('**<a:Nitro:727520490830168104> | Game Menu\n----------------------------\n<a:Nitro:727520490830168104> | ``-hl`` ⇏ لـعـبـة هـل تـعـلـم\n\n<a:Nitro:727520490830168104> | ``-mr`` ⇏ لـعـبـة مـريـم\n\n<a:Nitro:727520490830168104> | ``-e7`` ⇏ لـعـبـة احـزر الـفـريـق\n\n<a:Nitro:727520490830168104> | ``-lw`` ⇏ لـعـبـة لـو خـيـروك\n\n<a:Nitro:727520490830168104> | ``-3k`` ⇏ لـعـبـة عـقـاب\n\n<a:Nitro:727520490830168104> | ``-kt`` ⇏ لـعـبـة كـت تـويـت\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'About') {
      message.author.send('**<a:Nitro:727520490830168104> | About Menu\n----------------------------\n<a:Nitro:727520490830168104> | ``-bot`` ⇏ لـعـرض مـعـلـومـات عـن الـبـوت\n\n<a:Nitro:727520490830168104> | ``-inv`` ⇏ لـدعـوة الـبـوت لـسـيـرفـرك\n\n<a:Nitro:727520490830168104> | ``-support`` ⇏ لـعـرض سـيـرفـر الـدعـم الـفـنـي\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'support') {
 /// حط رابط سيرفرك مكان YourServer Here
      message.author.send('**<a:Nitro:727520490830168104> | Bot Support\n<a:Nitro:727520490830168104> - https://discord.gg/eavD4t**').catch(e => console.log(e.stack));
...
if (!message.guild) return message.reply('') 
if (message.content === prefix+'support') {
message.channel.send("<a:Truex2:727338203773927514> **-** **Check Your DM**")
  }
   });
...
if (message.content === prefix+'inv') {
      ...
      message.author.send('**<a:Nitro:727520490830168104> | Bot Invite\n<a:Nitro:727520490830168104>https://discordapp.com/oauth2/authorizeclient_id=726497689092620298&permissions=8&scope=bot**').catch(e => console.log(e.stack));
